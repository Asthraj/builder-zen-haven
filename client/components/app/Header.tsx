        ...
        <a href="/" className="flex items-center gap-2">
          <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground shadow">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 21c4.97 0 9-4.03 9-9 0-1.42-.33-2.77-.92-3.97-.22-.45-.82-.51-1.16-.17-2.76 2.76-4.92 2.55-6.92 1.4-2.02-1.16-4.14-1.14-6.93 1.4-.34.33-.93.28-1.15-.17C3.33 9.23 3 10.58 3 12c0 4.97 4.03 9 9 9Z" fill="currentColor"/>
              <path d="M7 12s2-3 5-3 5 3 5 3-2 3-5 3-5-3-5-3Z" fill="currentColor" opacity=".45"/>
            </svg>
          </span>
          <span className="font-extrabold text-lg tracking-tight">{t("app_name")}</span>
        </a>
        <div className="flex items-center gap-2">
          <span className={`px-2 py-1 rounded-full text-xs font-medium ${online ? "bg-secondary text-secondary-foreground" : "bg-destructive text-destructive-foreground"}`}>
